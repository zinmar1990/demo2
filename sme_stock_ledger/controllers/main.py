...
class StockCustomReportController(http.Controller):

    @http.route('/sme_stock_ledger', type='http', auth='user', methods=['POST'], csrf=False)
    def get_report(self, model, options, output_format, token, financial_id=None, **kw):
        uid = request.session.uid
        stock_report_model = request.env['stock.custom.report']
        ...
        try:
            if output_format == 'xlsx':
                response = request.make_response(
                    None,
                    headers=[
                        ('Content-Type', stock_report_model.get_export_mime_type('xlsx')),
            ...
            if output_format == 'pdf':
                response = request.make_response(
                    ...
                    headers=[
                        ('Content-Type', stock_report_model.get_export_mime_type('pdf')),
            ...
            if output_format == 'xml':
                ...
                response = request.make_response(
                    content,
                    headers=[
                        ('Content-Type', stock_report_model.get_export_mime_type('xml')),
            ...
            if output_format == 'xaf':
                ...
                response = request.make_response(
                    content,
                    headers=[
                        ('Content-Type', stock_report_model.get_export_mime_type('xaf')),
            ...
            if output_format == 'txt':
                ...
                response = request.make_response(
                    content,
                    headers=[
                        ('Content-Type', stock_report_model.get_export_mime_type('txt')),
            ...
            if output_format == 'csv':
                ...
                response = request.make_response(
                    content,
                    headers=[
                        ('Content-Type', stock_report_model.get_export_mime_type('csv')),
            ...
            if output_format == 'zip':
                ...
                response = request.make_response(
                    content,
                    headers=[
                        ('Content-Type', stock_report_model.get_export_mime_type('zip')),
